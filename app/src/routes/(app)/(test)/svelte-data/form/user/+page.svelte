...
<UserForm class='mb-4'>
	...
	<div
		class='p-2 px-3 border border-gray-700 rounded-lg'
		contenteditable
		bind:innerText={$UserForm.bind}
	>This is bound</div>
	...
	<div>
		<button onclick={() => ($UserForm.children ??= [{} as Person]).push({} as Person)} type='button'>
			Add child
		</button>
...
<Code code={{ 'result.json': JSON.stringify($UserForm, null, '    ') }} />
